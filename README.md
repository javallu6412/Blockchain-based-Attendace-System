...
- [VS Code](https://code.visualstudio.com/) as your code editor
...
### 2. Initialize the Project in VS Code
1. Download all file in the Codes folder to a folder in your system.
...
npm install
```
4. Your `package-lock.json` will be created automatically after `npm install`
